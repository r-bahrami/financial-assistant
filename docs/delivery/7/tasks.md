# Tasks for PBI 7: Budget Management System
...
| 7-5 | [Add budget vs actual reports](./7-5.md) | Done | Create charts showing budget performance over time (core features complete) |
