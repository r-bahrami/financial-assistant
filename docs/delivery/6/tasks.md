...
| 6-4 | [Implement notes feature for transactions](./6-4.md) | Done | Add UI and API to create, edit, and delete notes on transactions |
| 6-5 | [Implement tags system](./6-5.md) | Done | Create tag management UI, tag transactions, filter by tags |
| 6-6 | [Add bulk selection and operations](./6-6.md) | Done | Implement checkboxes, select all/none, bulk categorize, bulk tag |
