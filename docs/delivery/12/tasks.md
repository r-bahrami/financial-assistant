...
| 12-2 | [Implement Password Hashing and Authentication](./12-2.md) | Review | Add bcrypt/argon2 password hashing, authentication methods |
| 12-3 | [Add Flask-Login Session Management](./12-3.md) | Review | Integrate Flask-Login, create login/logout routes, secure sessions |
